...
from model import my_accuracy,cnn_res
...
def main(**kwargs):
    ...
    if 'model_path' in kwargs:
        ...
        model_path = 'cnn_res/models'

    if 'pretrain' in kwargs:
        pretrain = True if kwargs['pretrain'] == '1' else False 
    else:
        pretrain = True
    ...
    if True:
        model = keras.models.load_model(get_model_path(model_path),
                                custom_objects={'my_accuracy': my_accuracy,'Attention2':Attention2()})
...
#    for i in range(28):        
#        main(attmflmodel_path = ('models/attmfl'+str(i+3)))
    import fire
    fire.Fire(main)
