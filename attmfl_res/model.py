...
from keras.layers import Dense,Dropout,LSTM,Embedding,Input,multiply,Masking,BatchNormalization
...
class attmfl(object):
    ...
    def vqa_model(self,embedding_matrix,word_num,embedding_size,img_feature_dim,
        ...
        att_v = Attention()([vgg,question]) #[batch,4096]
        
        v_proj = Dense(1024,activation = 'tanh')(att_v)
        q_proj = Dense(1024,activation = 'tanh')(question)
        
        print("starting merging...")
        mul = multiply([v_proj,q_proj])
